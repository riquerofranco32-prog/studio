...
const productTypes: ProductTypeOption[] = [
  {
    ...
    baseUsd: 2500,
    description: "Aplicación completa con autenticación, base de datos relacional y panel de administración.",
    recommendedStack: ["Next.js 16", "React 19", "Supabase", "TypeScript", "Tailwind v4"],
  },
  {
    id: "ecommerce",
    name: "E-Commerce de Marca",
    badge: "Tienda Online",
    baseWeeks: "2 - 4 semanas",
    baseUsd: 1800,
    description: "Experiencia de compra ultrarrápida, catálogo dinámico y checkout optimizado para conversión.",
    recommendedStack: ["Next.js 16", "Stripe / MP", "Supabase", "Motion"],
  },
  {
    id: "landing",
    name: "Landing Page de Alto Impacto",
    badge: "Conversión & Craft",
    baseWeeks: "1 - 2 semanas",
    baseUsd: 1200,
    description: "Diseño visual cinematográfico, micro-animaciones, SEO 100/100 y copywriting estructurado.",
    recommendedStack: ["Next.js", "Framer Motion", "Tailwind v4", "SEO Schema"],
  },
  {
    id: "ai-climate",
    name: "Plataforma IA / Climate Tech",
    badge: "Datos & APIs",
    baseWeeks: "3 - 5 semanas",
    baseUsd: 2900,
    description: "Integración de modelos LLM, procesamiento de datos en vivo, mapas interactivos y APIs.",
    recommendedStack: ["Next.js", "OpenAI / Claude API", "Mapbox / FIRMS", "Supabase"],
  },
  {
    id: "redesign",
    name: "Rediseño & Migración Next.js",
    badge: "Performance & Craft",
    baseWeeks: "2 - 3 semanas",
    baseUsd: 1500,
    description: "Modernización de producto existente: optimización de Core Web Vitals y renovación visual.",
